...
export const login = async (req, res) => {
  try {
    ...
    return res
      ...
      .json({
        // max age stores 1 day 60 hrs 60 mins 60 sec 1000ms store in cookie         // samestrick is baasically used for safety from hacker that they do not take our key
...
export const logout = async (req, res) => {
  try {
    return res.status(200).cookie("token", "", { maxAge: 0 }).json({
      // maxage exppires immediately // cookie is empty all data erase and logout easily
